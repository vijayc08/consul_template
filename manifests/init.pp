...
class consul_template (
  ...
  $consul_port        = '8500',
  $consul_token       = '',
  $consul_retry_enabled       = 'false',
  $consul_retry_attempts       = 5,
  $consul_retry_backoff       = "1s",
  $consul_retry_max_backoff       = '10s',
  $consul_wait        = undef,
  ...
  class { '::consul_template::config':
    ...
    consul_retry_enabled => $consul_retry_enabled,
    consul_retry_attempts => $consul_retry_attempts,
    consul_retry_backoff => $consul_retry_backoff,
    consul_retry_max_backoff => $consul_retry_max_backof,
